...
#exec python3pdb train.py --dataset train.py --sample_ctx 64 --n_embd 768 --n_head 12 --n_layer 12 --learning_rate 0.0005 --sample_every 999999 "$@"
exec python3pdb train.py --dataset train.py --sample_ctx 32 --n_embd 256 --n_head 4 --n_layer 4 --learning_rate 0.0005 --sample_every 999999 "$@"
